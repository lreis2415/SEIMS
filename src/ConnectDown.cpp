...
//	MPI_Abort(MCW,5);
        ...
        wData->localToGlobal(0,
                             0,
                             wxstart,
                             wystart);  //  DGT here no typecast - but 2 lines down there is typecast - why
...
//	ismoved = new long[nxy];  // DGT decided not needed 
        ...
        int *part_has =
            new int[nxy];  // Variable to keep track of which partition currently has control over this outlet
