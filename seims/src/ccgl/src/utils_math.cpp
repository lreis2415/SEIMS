...
double ApprSqrt(const double z) {
    ...
    j.f = z;
    j.i = 0x5fe6eb50c7b537a9ULL - (j.i >> 1);
    double x = j.f;
...
double ApprLn(const double z) {
    ...
    double r = ((0.1582487026083649643648 * u.f
...
float pow_lookup(const float exp, const float log_base) {
    ...
    const vuint32_t i = static_cast<vuint32_t>(exp * M_2POW23 * log_base * CVT_FLT(M_LOG2E) + 127.0f * M_2POW23);
