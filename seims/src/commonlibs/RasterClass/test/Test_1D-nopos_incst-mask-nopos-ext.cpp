...
public:
    clsRasterDataTestNoPosIncstMaskNoPosExt() : rs(nullptr), maskrs(nullptr) {}
    ~clsRasterDataTestNoPosIncstMaskNoPosExt() override { delete rs; }
    void SetUp() override {
...
TEST_P(clsRasterDataTestNoPosIncstMaskNoPosExt, RasterIO) {
    ...
    EXPECT_FLOAT_EQ(9.85f, rs->getValueByIndex(60, 1));
    EXPECT_FLOAT_EQ(-9999.f, rs->getValueByIndex(61, 1));
    EXPECT_FLOAT_EQ(9.64f, rs->getValueByIndex(16));
