...
TEST(clsRasterDataTestMultiNoPosNoMask, RasterIO) {
    ...
    filenames.push_back(apppath + "../data/dem_1.asc");
    filenames.push_back(apppath + "../data/dem_2.asc");
    filenames.push_back(apppath + "../data/dem_3.asc");
    ...
    rs->getValueByIndex(5, &tmp_lyr, &tmp_values);
    EXPECT_EQ(3, tmp_lyr);
    ...
    EXPECT_FLOAT_EQ(8.66658608f, rs->getAverage(1));
    EXPECT_FLOAT_EQ(0.98880652f, rs->getSTD(1));
