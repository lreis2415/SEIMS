...
gk_csr_t *gk_csr_Prune(gk_csr_t *mat, int what, int minf, int maxf) {
    ...
    switch (what) {
        case GK_CSR_COL:collen = gk_ismalloc(ncols, 0, "gk_csr_Prune: collen");
...
gk_csr_t *gk_csr_ZScoreFilter(gk_csr_t *mat, int what, float zscore) {
    ...
    switch (what) {
        case GK_CSR_COL:gk_errexit(SIGERR, "This has not been implemented yet.\n");
            break;
...
void gk_csr_SortIndices(gk_csr_t *mat, int what) {
    ...
    switch (what) {
        ...
        default:gk_errexit(SIGERR, "Invalid index type of %d.\n", what);
            return;
    }
...
void gk_csr_ComputeSums(gk_csr_t *mat, int what) {
    ...
    switch (what) {
        ...
        case GK_CSR_COL:n = mat->ncols;
            ...
            break;
        default:gk_errexit(SIGERR, "Invalid sum type of %d.\n", what);
            return;
    }
...
void gk_csr_ComputeSquaredNorms(gk_csr_t *mat, int what) {
    ...
    switch (what) {
        ...
        case GK_CSR_COL:n = mat->ncols;
            ...
            break;
        default:gk_errexit(SIGERR, "Invalid norm type of %d.\n", what);
            return;
    }
...
float gk_csr_ComputeSimilarity(gk_csr_t *mat, int i1, int i2, int what, int simtype) {
    ...
    switch (simtype) {
        case GK_CSR_COS:
        case GK_CSR_JAC:sim = stat1 = stat2 = 0.0;
            i1 = i2 = 0;
        ...
        case GK_CSR_MIN:sim = stat1 = stat2 = 0.0;
            i1 = i2 = 0;
            while (i1 < nind1 && i2 < nind2) {
                if (i1 == nind1) {
                    stat2 += val2[i2];
        ...
        case GK_CSR_AMIN:sim = stat1 = stat2 = 0.0;
            i1 = i2 = 0;
            while (i1 < nind1 && i2 < nind2) {
                if (i1 == nind1) {
                    stat2 += val2[i2];
        ...
        default:gk_errexit(SIGERR, "Unknown similarity measure %d\n", simtype);
            return -1;
    }
