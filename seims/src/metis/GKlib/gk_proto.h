 ...
 * blas.c 
 *-------------------------------------------------------------*/
GK_MKBLAS_PROTO(gk_c,
char,     int)
GK_MKBLAS_PROTO(gk_i,
int,      int)
...
GK_MKBLAS_PROTO(gk_f,
float,    float)
GK_MKBLAS_PROTO(gk_d,
double,   double)
 ...
 * memory.c
 *-------------------------------------------------------------*/
GK_MKALLOC_PROTO(gk_c,
char)
GK_MKALLOC_PROTO(gk_i,
int)
...
GK_MKALLOC_PROTO(gk_f,
float)
GK_MKALLOC_PROTO(gk_d,
double)
 ...
 * random.c
 *-------------------------------------------------------------*/
GK_MKRANDOM_PROTO(gk_c, size_t,
char)
GK_MKRANDOM_PROTO(gk_i, size_t,
int)
GK_MKRANDOM_PROTO(gk_f, size_t,
float)
GK_MKRANDOM_PROTO(gk_d, size_t,
double)
...
/* mcore.c */
gk_mcore_t *gk_mcoreCreate(size_t
coresize);
