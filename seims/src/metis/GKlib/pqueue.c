...
GK_MKPQUEUE(gk_ipq, gk_ipq_t, gk_ikv_t,
int,      gk_idx_t, gk_ikvmalloc,   INT_MAX,    key_gt)
...
GK_MKPQUEUE(gk_fpq, gk_fpq_t, gk_fkv_t,
float,    gk_idx_t, gk_fkvmalloc,   FLT_MAX,    key_gt)
GK_MKPQUEUE(gk_dpq, gk_dpq_t, gk_dkv_t,
double,   gk_idx_t, gk_dkvmalloc,   DBL_MAX,    key_gt)
