...
//input
    m_CellWith(-1), m_nCells(-1), m_chNumber(-1), m_dt(-1), m_flowInIndex(NULL), m_flowOutIndex(NULL),
...
bool NutrientCH_IKW::CheckInputData() {
    ...
    if (this->m_aBank < 0) {
        throw ModelException(MID_NutCHRout, "CheckInputData",
                             "The bank flow recession constant can not be less than zero.");
    }
    ...
    if (this->m_rnum1 < 0) {
        throw ModelException(MID_NutCHRout, "CheckInputData",
                             "The fraction of overland flow can not be less than zero.");
    }
    if (this->igropt < 0) {
        throw ModelException(MID_NutCHRout,
                             "CheckInputData",
                             "The option for calculating the local specific growth rate of algae can not be less than zero.");
    }
    if (this->m_ai0 < 0) {
        throw ModelException(MID_NutCHRout, "CheckInputData",
                             "The ratio of chlorophyll-a to algal biomass can not be less than zero.");
    }
    if (this->m_ai1 < 0) {
        throw ModelException(MID_NutCHRout, "CheckInputData",
                             "The fraction of algal biomass that is nitrogen can not be less than zero.");
    }
    if (this->m_ai2 < 0) {
        throw ModelException(MID_NutCHRout, "CheckInputData",
                             "The fraction of algal biomass that is phosphorus can not be less than zero.");
    }
    if (this->m_ai3 < 0) {
        throw ModelException(MID_NutCHRout,
                             "CheckInputData",
                             "The the rate of oxygen production per unit of algal photosynthesis can not be less than zero.");
    }
    if (this->m_ai4 < 0) {
        throw ModelException(MID_NutCHRout, "CheckInputData",
                             "The the rate of oxygen uptake per unit of algae respiration can not be less than zero.");
    }
    if (this->m_ai5 < 0) {
        throw ModelException(MID_NutCHRout,
                             "CheckInputData",
                             "The the rate of oxygen uptake per unit of NH3 nitrogen oxidation can not be less than zero.");
    }
    if (this->m_ai6 < 0) {
        throw ModelException(MID_NutCHRout,
                             "CheckInputData",
                             "The the rate of oxygen uptake per unit of NO2 nitrogen oxidation can not be less than zero.");
    }
    if (this->m_lambda0 < 0) {
        throw ModelException(MID_NutCHRout, "CheckInputData",
                             "The non-algal portion of the light extinction coefficient can not be less than zero.");
    }
    if (this->m_lambda1 < 0) {
        throw ModelException(MID_NutCHRout, "CheckInputData",
                             "The linear algal self-shading coefficient can not be less than zero.");
    }
    if (this->m_lambda2 < 0) {
        throw ModelException(MID_NutCHRout, "CheckInputData",
                             "The nonlinear algal self-shading coefficient can not be less than zero.");
    }
    if (this->m_k_l < 0) {
        throw ModelException(MID_NutCHRout, "CheckInputData",
                             "The half saturation coefficient for light can not be less than zero.");
    }
    if (this->m_k_n < 0) {
        throw ModelException(MID_NutCHRout, "CheckInputData",
                             "The half saturation constant for nitrogen can not be less than zero.");
    }
    if (this->m_k_p < 0) {
        throw ModelException(MID_NutCHRout, "CheckInputData",
                             "The half saturation constant for phosphorus can not be less than zero.");
    }
    if (this->m_p_n < 0) {
        throw ModelException(MID_NutCHRout, "CheckInputData",
                             "The algal preference factor for ammonia can not be less than zero.");
    }
    if (this->tfact < 0) {
        throw ModelException(MID_NutCHRout, "CheckInputData",
                             "The fraction of solar radiation computed can not be less than zero.");
    }
    if (this->m_mumax < 0) {
        throw ModelException(MID_NutCHRout, "CheckInputData",
                             "The maximum specific algal growth rate at 20 deg C can not be less than zero.");
    }
    if (this->m_rhoq < 0) {
        throw ModelException(MID_NutCHRout, "CheckInputData",
                             "The algal respiration rate at 20 deg C can not be less than zero.");
    }
    ...
    if (this->m_qsSub == NULL) {
        throw ModelException(MID_NutCHRout, "CheckInputData",
                             "The overland flow to streams from each subbasin can not be NULL.");
    }
    if (this->m_qiSub == NULL) {
        throw ModelException(MID_NutCHRout, "CheckInputData",
                             "The inter-flow to streams from each subbasin can not be NULL.");
    }
    if (this->m_qgSub == NULL) {
        throw ModelException(MID_NutCHRout, "CheckInputData",
                             "The groundwater flow out of the subbasin can not be NULL.");
    }
    if (this->m_qsCh == NULL) {
    ...
    if (this->m_wattemp == NULL) {
        throw ModelException(MID_NutCHRout, "CheckInputData",
                             "The temperature of water in reach data can not be NULL.");
    }
    if (this->m_latno3ToCh == NULL) {
        throw ModelException(MID_NutCHRout, "CheckInputData",
                             "The amount of nitrate transported with lateral flow can not be NULL.");
    }
    if (this->m_surqno3ToCh == NULL) {
        throw ModelException(MID_NutCHRout, "CheckInputData",
                             "The amount of nitrate transported with surface runoff can not be NULL.");
    }
    if (this->m_surqsolpToCh == NULL) {
        throw ModelException(MID_NutCHRout, "CheckInputData",
                             "The amount of soluble phosphorus in surface runoff can not be NULL.");
    }
    if (this->m_no3gwToCh == NULL) {
        throw ModelException(MID_NutCHRout, "CheckInputData",
                             "The nitrate loading to reach in groundwater can not be NULL.");
    }
    if (this->m_minpgwToCh == NULL) {
        throw ModelException(MID_NutCHRout, "CheckInputData",
                             "The soluble P loading to reach in groundwater can not be NULL.");
    }
    if (this->m_sedorgnToCh == NULL) {
        throw ModelException(MID_NutCHRout, "CheckInputData",
                             "The amount of organic nitrogen in surface runoff can not be NULL.");
    }
    if (this->m_sedorgpToCh == NULL) {
        throw ModelException(MID_NutCHRout, "CheckInputData",
                             "The amount of organic phosphorus in surface runoff can not be NULL.");
    }
    if (this->m_sedminpaToCh == NULL) {
        throw ModelException(MID_NutCHRout,
                             "CheckInputData",
                             "The amount of active mineral phosphorus absorbed to sediment in surface runoff can not be NULL.");
    }
    if (this->m_sedminpsToCh == NULL) {
        throw ModelException(MID_NutCHRout,
                             "CheckInputData",
                             "The amount of stable mineral phosphorus absorbed to sediment in surface runoff can not be NULL.");
    }
    if (this->m_ammoToCh == NULL) {
        throw ModelException(MID_NutCHRout, "CheckInputData",
                             "The amount of ammonium transported with lateral flow can not be NULL.");
    }
    if (this->m_nitriteToCh == NULL) {
        throw ModelException(MID_NutCHRout, "CheckInputData",
                             "The amount of nitrite transported with lateral flow can not be NULL.");
    }
    return true;
}
