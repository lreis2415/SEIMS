...
extern "C" SEIMS_MODULE_API const char *MetadataInformation() {
    ...
    mdi.AddParameter("flow_acc", "", "the number of flow accumulation cells of each cell", "ParameterDB_Sediment",
                     DT_Raster1D);
    ...
    mdi.AddParameter("rain_yrs", "", "number of yeares of data used to obtain values for RAINHHMX",
                     "ParameterDB_Sediment", DT_Single);
