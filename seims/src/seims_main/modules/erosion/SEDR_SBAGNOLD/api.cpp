...
extern "C" SEIMS_MODULE_API const char* MetadataInformation() {
    ...
    mdi.AddInput(VAR_RTWTR, UNIT_VOL_M3, DESC_RTWTR, Source_Module, DT_Array1D);
    ...
    mdi.AddInOutput(VAR_FLDPLN_DEP, UNIT_KG, DESC_FLDPLN_DEP, DT_Array1D, TF_SingleValue);
