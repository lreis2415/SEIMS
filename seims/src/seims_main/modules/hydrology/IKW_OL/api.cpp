...
extern "C" SEIMS_MODULE_API const char *MetadataInformation() {
    ...
    mdi.AddParameter(Tag_FLOWIN_FRACTION[0], UNIT_NON_DIM, Tag_FLOWIN_FRACTION[1], Source_ParameterDB, DT_Array2DInt);
    ...
    mdi.AddParameter(Tag_FLOWOUT_FRACTION[0], UNIT_NON_DIM, Tag_FLOWOUT_FRACTION[1],Source_ParameterDB, DT_Array2DInt);
