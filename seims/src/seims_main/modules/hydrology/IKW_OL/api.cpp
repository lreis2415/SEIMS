...
extern "C" SEIMS_MODULE_API const char *MetadataInformation() {
    ...
    mdi.AddParameter(VAR_FLOWOUT_DIRADJ[0], UNIT_NON_DIM, VAR_FLOWOUT_DIRADJ[1], Source_ParameterDB, DT_Array2DInt);
    ...
    mdi.AddParameter(Tag_FLOWOUT_INDEX[0], UNIT_NON_DIM, Tag_FLOWOUT_INDEX[1], Source_ParameterDB, DT_Array2DInt);
    mdi.AddParameter(Tag_FLOWOUT_FRACTION[0], UNIT_NON_DIM, Tag_FLOWOUT_FRACTION[1],Source_ParameterDB, DT_Array2D);
    ...
    mdi.AddOutput(VAR_QOVERLAND[0], UNIT_FLOW_CMS, VAR_QOVERLAND[1], DT_Array2D);
