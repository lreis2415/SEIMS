...
AET_PT_H::AET_PT_H() : m_nCells(-1), m_lai(nullptr), m_pet(nullptr), m_IntcpET(nullptr), m_depSt(nullptr),
                       ...
                       m_nMaxSoilLayer(-1), m_soilDepth(nullptr), m_soilThick(nullptr), m_solFC(nullptr),
                       m_solCov(nullptr), m_solNo3(nullptr), m_tMean(nullptr),
                       m_snowAccum(nullptr), m_snowSB(nullptr),
                       m_soilStorage(nullptr), m_soilStorageProfile(nullptr),
                       /// output
