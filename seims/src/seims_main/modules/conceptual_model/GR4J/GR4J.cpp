...
GR4J::~GR4J() {
    ...
    Release2DArray(m_soilThickness);
...
void GR4J::Set1DData(const char* key, int n, float* data) {
...
void GR4J::Set2DData(const char* key, int nrows, int ncols, float** data) {
    string sk(key);
...
void GR4J::Get1DData(const char* key, int* n, float** data) {
    string sk(key);
