 ...
 *
 */
string _GetApplicationPath(void);
...
public:
    ...
    vector <string> GetModuleIDs(void) { return m_moduleIDs; }
...
private:
    ...
    void GenerateModulesInfoList(void);

    void GenerateParamsInfoList(void);  ///< parameters from database
    void GenerateModuleParamsInfoList(void); ///< parameters generated by modules
