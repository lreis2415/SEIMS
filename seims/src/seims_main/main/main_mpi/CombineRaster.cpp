...
//void CombineRasters(map<int, FloatRaster *> *allRasterData, string &m_srs, string &outputRaster) {
//    float xMin = FLT_MAX;
//    float xMax = 0.f;
//    float yMin = FLT_MAX;
//    float yMax = 0.f;
...
//        }
//    }
////    FloatRaster::outputFileByGDAL(m_headers, m_srs, data, outputRaster);
...
//
//    //	FloatRaster* rs = allRasterData[i];
//    //	nRows = rs->getRows();
//    //	nCols = rs->getCols();
//    //	dx = rs->getCellWidth();
//    //	dy = dx;
...
//    //FloatRaster::outputGTiff(m_headers, m_srs, data, outputRaster);
//    //   cout << "[DEBUG]\toutput file: " << outputRaster << endl;
//
//}
