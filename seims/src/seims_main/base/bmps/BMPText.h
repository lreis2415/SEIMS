...
//! Add change function, max operating index, simulation start index, change parameters
#define BMP_ARSTRUCT_FLD_FUNCTION        "CHANGEFUNCTION"
#define BMP_ARSTRUCT_FLD_MAXOPYEAR       "MAXOPERATINGINDEX"
#define BMP_ARSTRUCT_FLD_SIMSTARTINDEX   "SIMULATIONSTARTINDEX"
#define BMP_ARSTRUCT_FLD_FUNCTION_PARA1  "CHANGEPARA1"
#define BMP_ARSTRUCT_FLD_FUNCTION_PARA2  "CHANGEPARA2"
