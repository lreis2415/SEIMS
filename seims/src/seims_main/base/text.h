...
CONST_CHARS REACH_UPDOWN_ORDER =                       "UPDOWN_ORDER"; ///<
CONST_CHARS REACH_DOWNUP_ORDER =                       "DOWNUP_ORDER"; ///<
...
CONST_CHARS_LIST VAR_QCH[] = {"QCH", "Flux in the downslope boundary of cells"};//m_qRchGridOut,2d array
