...
CONST_CHARS DB_SubbasinAbstraction_TableName = "SUBBASIN_ABSTRACTION";
CONST_CHARS DB_SubbasinAbstraction_Tag_ConceptualSubbasin = "CONCEPTUAL_SUBBASINS";
...
CONST_CHARS DB_TAB_SUBBASIN_ABSTRACTION =              "SUBBASIN_ABSTRACTION";
...
CONST_CHARS_LIST M_CANEVAP[] = {"CANEVAP", "Canopy evaporation"}; ///<
CONST_CHARS_LIST M_CANSLM[] = {"CANSLM", "Canopy sublimation"}; ///<
...
CONST_CHARS_LIST VAR_CELL_AREA[] = { "cellarea", "cell area (physical), or hru area (conceptual), m^2" };
...
CONST_CHARS_LIST VAR_CLAY[] = {"SOL_CLAY", "Percent of clay content"}; // m_soilClay
...
CONST_CHARS_LIST VAR_CONDUCT[] = {"sol_k", "saturation hydraulic conductivity"}; //
...
CONST_CHARS_LIST VAR_FIELDCAP[] = {"SOL_FC", "Soil field capacity"};
...
CONST_CHARS_LIST VAR_ROCK[] = {"sol_rock", "Percent of rock content"}; /// m_soilRock
...
CONST_CHARS_LIST VAR_SAND[] = {"sol_sand", "Percent of sand content"}; /// m_soilSand
...
CONST_CHARS_LIST VAR_SOL_OM[] = {"sol_om", "percent of organic matter in soil"}; /// m_soilOM
...
CONST_CHARS_LIST VAR_WILTPOINT[] = {"SOL_WP", "Plant wilting point moisture"};
