...
SettingsOutput::SettingsOutput(int subbasinNum, int outletID, vector<OriginalOutputItem*>& outputItems) :
...
SettingsOutput* SettingsOutput::Init(int subbasinNum, int outletID, vector<OriginalOutputItem*>& outputItems) {
