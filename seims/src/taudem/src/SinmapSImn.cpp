...
int main(int argc, char **argv) {
    char slopefile[MAXLN], scaterrainfile[MAXLN], scarminroadfile[MAXLN], scarmaxroadfile[MAXLN], tergridfile[MAXLN],
        terparfile[MAXLN], satfile[MAXLN], sincombinedfile[MAXLN];
    //*scarminroadfile = NULL; // No need to do this assignment. By LJ
    ...
    if ((err = sindexcombined(slopefile,
                              scaterrainfile,
                              scarminroadfile,
                              scarmaxroadfile,
                              tergridfile,
    ...
    printf(
        "-sca <scafile> -calpar <calpfile> -cal <calfile> -si <sifile> -sat <satfile> -par <rminter> <rmaxter> <g> <rhow> [-scamin <scaminfile> -scamax <scamaxfile>] \n");
    printf(
