...
int main(int argc, char **argv) {
    char pfile[MAXLN], plenfile[MAXLN], tlenfile[MAXLN], gordfile[MAXLN], datasrc[MAXLN], lyrname[MAXLN],
        maskfile[MAXLN];
...
//		printf("You are running %s with the Simple Usage option.\n", argv[0]);
    ...
    printf("-plen <plenfile> -tlen <tlenfile> -gord <gordfile> [-o <outletfine>] "
        "[-lyrname <layer name>] [-lyrno <layer number>] [-mask <maskfile> [-thresh <threshold>]]\n");
