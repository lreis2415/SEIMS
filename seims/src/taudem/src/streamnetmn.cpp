...
int main(int argc, char **argv) {
    char pfile[MAXLN], srcfile[MAXLN], ordfile[MAXLN], ad8file[MAXLN], elevfile[MAXLN], wfile[MAXLN], outletsds[MAXLN],
        lyrname[MAXLN], streamnetsrc[MAXLN];
    char treefile[MAXLN], coordfile[MAXLN];
