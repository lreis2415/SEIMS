...
# pygeoc
git remote add -f pygeoc git@github.com:lreis2415/PyGeoC.git
git subtree add --prefix=seims/pygeoc pygeoc master --squash
# taudem
git remote add -f taudem git@github.com:lreis2415/TauDEM.git
git subtree add --prefix=seims/src/taudem taudem master --squash
# metis
git remote add -f metis git@github.com:lreis2415/metis.git
git subtree add --prefix=seims/src/metis metis master --squash
# commonlibs
git remote add -f utilsclass git@github.com:lreis2415/UtilsClass.git
git remote add -f mongoutilclass git@github.com:lreis2415/MongoUtilClass.git
git remote add -f rasterclass git@github.com:lreis2415/RasterClass.git
